...
public class Rexiaodapter extends BaseAdapter {
    private Context context;
    private List<ShowBean.ResultBean.RxxpBean.CommodityListBean> list;

    public Rexiaodapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<ShowBean.ResultBean.RxxpBean.CommodityListBean> list) {
        this.list = list;
